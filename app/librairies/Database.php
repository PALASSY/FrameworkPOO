...
class Database{
  ...
  //Ici se trouve tout ce qui est au démarrage
    ...
    //Sécuriser les données avec (bindvalue) => lier
    public function bind($param, $value, $type=null){
      ...
      //on relie les différents éléments dans la table de la BDD
      $this -> stmt -> bindValue($param,$value,$type);
    }
    /******************************************************/
    //Executé les requêtes préparées (INSERT)
    public function execute(){
      return $this -> stmt -> execute();
    }

    /****************************************************/
    //Prévoir de retourner toutes lignes dans un tableau d'Objet
    ...
    /*************************************************************/
    //Prévoir de retourner une seule ligne de la table
